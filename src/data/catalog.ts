...
export const products: Product[] = [
  // Escobas
  {
    ...
    image: '/imagenes-productos/escoba-dr-cerda-suave.png',
    sku: 'ESC-001',
    price: 17000,
    active: true,
    order: 1
  },
  {
    ...
    image: '/imagenes-productos/escoba-zulia-cerda-suabe.png',
    sku: 'ESC-002',
    price: 16000,
    active: true,
    order: 2
  },
  {
    ...
    image: '/imagenes-productos/escoba-dura-cerda-zulia.png',
    sku: 'ESC-003',
    price: 19000,
    active: true,
    order: 3
  },
  {
    ...
    image: '/imagenes-productos/escoba-neon-cerda-suave.png',
    sku: 'ESC-004',
    price: 17500,
    active: true,
    order: 4
  },
  {
    ...
    image: '/imagenes-productos/escoba-tr-tipo-cerda-dura.png',
    sku: 'ESC-005',
    price: 18000,
    active: true,
    order: 5
  },
  {
    ...
    image: '/imagenes-productos/escoba-tr-tipo-cerda-suave.png',
    sku: 'ESC-006',
    price: 18000,
    active: true,
    order: 6
  },
  {
    ...
    image: '/imagenes-productos/escoba-wm-cerda-suave.png',
    sku: 'ESC-007',
    price: 20000,
    active: true,
    order: 7
  ...
  // Cepillos
  {
    ...
    image: '/imagenes-productos/cepillo-brillo-tipo-cerda-suave-multiusos.png',
    sku: 'CEP-001',
    price: 11000,
    active: true,
    order: 1
  ...
  },
  {
    ...
    image: '/imagenes-productos/cepillo-telarañero.png',
    sku: 'CEP-003',
    price: 15000,
    active: true,
    order: 3
  },
  {
    ...
    image: '/imagenes-productos/churrasco-para-baño.png',
    sku: 'CEP-004',
    price: 14000,
    active: true,
    order: 4
  },
  {
    ...
    image: '/imagenes-productos/rastrillo.png',
    sku: 'CEP-005',
    price: 16000,
    active: true,
    order: 5
  },
  {
    ...
    image: '/imagenes-productos/recogedor-plus-banda.png',
    sku: 'CEP-006',
    price: 10000,
    active: true,
    order: 6
  },
  {
    ...
    image: '/imagenes-productos/recogedor-smart.png',
    sku: 'CEP-007',
    price: 12000,
    active: true,
    order: 7
  ...
  // Traperos
  {
    ...
    image: '/imagenes-productos/trapero-micro-fibra.png',
    sku: 'TRP-001',
    price: 25000,
    active: true,
    order: 1
  },
  {
    ...
    image: '/imagenes-productos/trapero-tipo-copa.png',
    sku: 'TRP-002',
    price: 15000,
    active: true,
    order: 2
  ...
  // Jabones y Químicos
  {
    ...
    image: '/imagenes-productos/detergente-liquido-4000ml-2000ml-1000ml.png',
    sku: 'JAB-001',
    price: 8500,
    active: true,
    order: 1
  },
  {
    ...
    image: '/imagenes-productos/jabon-crema-lavaloza-1000g.png',
    sku: 'JAB-002',
    price: 9500,
    active: true,
    order: 2
  },
  {
    ...
    image: '/imagenes-productos/jabon-dado-taza-250grs.png',
    sku: 'JAB-003',
    price: 4500,
    active: true,
    order: 3
  },
  {
    ...
    image: '/imagenes-productos/jabon-liquido-poara-manos.png',
    sku: 'JAB-004',
    price: 12000,
    active: true,
    order: 4
  },
  {
    ...
    image: '/imagenes-productos/limpiadores-cocina.png',
    sku: 'JAB-005',
    price: 10000,
    active: true,
    order: 5
  },
  {
    ...
    image: '/imagenes-productos/limpiadores-multiusos.png',
    sku: 'JAB-006',
    price: 8000,
    active: true,
    order: 6
  },
  {
    ...
    image: '/imagenes-productos/limpia-vidrios.png',
    sku: 'JAB-007',
    price: 7500,
    active: true,
    order: 7
  ...
  // Esponjas
  {
    ...
    image: '/imagenes-productos/esponja-doble-uso-x24-unidades.png',
    sku: 'ESP-001',
    price: 18000,
    active: true,
    order: 1
  },
  {
    ...
    image: '/imagenes-productos/esponja-multiusos-x12-paquetes-detres-unidades.png',
    sku: 'ESP-002',
    price: 25000,
    active: true,
    order: 2
  ...
  },
  {
    ...
    image: '/imagenes-productos/esponjas-power-x2unid.png',
    sku: 'ESP-004',
    price: 4000,
    active: true,
    order: 4
  ...
  },
  {
    ...
    image: '/imagenes-productos/esponjilla-de-brillo-x12unidades.png',
    sku: 'ESP-006',
    price: 15000,
    active: true,
    order: 6
  },
  {
    ...
    image: '/imagenes-productos/esponjilla-earth-x12unidades.png',
    sku: 'ESP-007',
    price: 14000,
    active: true,
    order: 7
  },
  {
    ...
    image: '/imagenes-productos/esponjilla-malla-sencilla-x12pares.png',
    sku: 'ESP-008',
    price: 12000,
    active: true,
    order: 8
  },
  {
    ...
    image: '/imagenes-productos/esponjilla-marca-james-x12unidades.png',
    sku: 'ESP-009',
    price: 13500,
    active: true,
    order: 9
  },
  {
    ...
    image: '/imagenes-productos/esponjilla-multiusos-x12unidades.png',
    sku: 'ESP-010',
    price: 13000,
    active: true,
    order: 10
  },
  {
    ...
    image: '/imagenes-productos/esponjilla-powerd.png',
    sku: 'ESP-011',
    price: 2500,
    active: true,
    order: 11
  },
  {
    ...
    image: '/imagenes-productos/sabra-super-abrasiva-7x10cm-10x14cm-ideales-parrillas-pesado.png',
    sku: 'ESP-012',
    price: 3500,
    active: true,
    order: 12
  ...
  // Varios
  {
    ...
    image: '/imagenes-productos/chupa-sanitario-plastico-economica.png',
    sku: 'VAR-001',
    price: 8000,
    active: true,
    order: 1
  },
  {
    ...
    image: '/imagenes-productos/guantes-desechables-x100unidades-restaurantes.png',
    sku: 'VAR-002',
    price: 25000,
    active: true,
    order: 2
  ...
  },
  {
    ...
    image: '/imagenes-productos/rollo-cinta-trasnparente-delgada-12mmX12eterna.png',
    sku: 'VAR-004',
    price: 3500,
    active: true,
    order: 4
  },
  {
    ...
    image: '/imagenes-productos/rollo-cinta-x12unidades.png',
    sku: 'VAR-005',
    price: 35000,
    active: true,
    order: 5
  },
  {
    ...
    image: '/imagenes-productos/condones-20sets-x3pcs.png',
    sku: 'VAR-006',
    price: 45000,
    active: true,
    order: 6
