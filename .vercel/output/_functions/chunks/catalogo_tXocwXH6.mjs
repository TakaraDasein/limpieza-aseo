...
const $$InteractiveCatalog = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="py-16 transition-all duration-700 bg-gradient-to-br from-surface via-surface-container-low to-surface" id="products-section" data-active-category="" data-astro-cid-t5fw7d4k> <div class="max-w-screen-2xl mx-auto px-6 md:px-12" data-astro-cid-t5fw7d4k> <!-- Search and Price Filter --> <div class="mb-12 max-w-2xl mx-auto" data-astro-cid-t5fw7d4k> <!-- Search Bar --> <div class="relative bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden" data-astro-cid-t5fw7d4k> <div class="absolute inset-y-0 left-0 pl-6 flex items-center pointer-events-none" data-astro-cid-t5fw7d4k> <span class="material-symbols-outlined text-2xl text-on-surface-variant" data-astro-cid-t5fw7d4k>search</span> </div> <input type="text" id="product-search" placeholder="Buscar productos por nombre..." class="w-full pl-16 pr-16 py-5 text-lg bg-transparent focus:outline-none focus:ring-0 text-on-surface placeholder-on-surface-variant" data-astro-cid-t5fw7d4k> <button id="clear-search" class="absolute inset-y-0 right-0 pr-6 flex items-center opacity-0 pointer-events-none transition-opacity duration-200" aria-label="Limpiar búsqueda" data-astro-cid-t5fw7d4k> <span class="material-symbols-outlined text-2xl text-on-surface-variant hover:text-primary transition-colors cursor-pointer" data-astro-cid-t5fw7d4k>close</span> </button> </div> <!-- Price Range Filter --> <div class="mt-4 bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden p-6" data-astro-cid-t5fw7d4k> <div class="flex items-center justify-between mb-4" data-astro-cid-t5fw7d4k> <div class="flex items-center gap-2" data-astro-cid-t5fw7d4k> <span class="material-symbols-outlined text-2xl text-on-surface-variant" data-astro-cid-t5fw7d4k>payments</span> <h3 class="font-semibold text-on-surface" data-astro-cid-t5fw7d4k>Rango de Precio</h3> </div> <button id="clear-price" class="text-sm text-primary hover:text-secondary transition-colors font-medium opacity-0 pointer-events-none" aria-label="Limpiar filtro de precio" data-astro-cid-t5fw7d4k>
Limpiar
</button> </div> <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4" data-astro-cid-t5fw7d4k> <!-- Min Price Input --> <div class="relative" data-astro-cid-t5fw7d4k> <label for="min-price" class="text-xs font-semibold text-on-surface-variant mb-2 block" data-astro-cid-t5fw7d4k>Precio Mínimo</label> <div class="relative" data-astro-cid-t5fw7d4k> <span class="absolute inset-y-0 left-0 pl-4 flex items-center text-on-surface-variant pointer-events-none" data-astro-cid-t5fw7d4k>$</span> <input type="number" id="min-price" placeholder="0" min="0" step="1000" class="w-full pl-8 pr-4 py-3 border-2 border-surface-container rounded-xl focus:border-primary focus:outline-none text-on-surface transition-all" data-astro-cid-t5fw7d4k> </div> </div> <!-- Max Price Input --> <div class="relative" data-astro-cid-t5fw7d4k> <label for="max-price" class="text-xs font-semibold text-on-surface-variant mb-2 block" data-astro-cid-t5fw7d4k>Precio Máximo</label> <div class="relative" data-astro-cid-t5fw7d4k> <span class="absolute inset-y-0 left-0 pl-4 flex items-center text-on-surface-variant pointer-events-none" data-astro-cid-t5fw7d4k>$</span> <input type="number" id="max-price" placeholder="∞" min="0" step="1000" class="w-full pl-8 pr-4 py-3 border-2 border-surface-container rounded-xl focus:border-primary focus:outline-none text-on-surface transition-all" data-astro-cid-t5fw7d4k> </div> </div> </div> <!-- Current Price Range Display --> <div id="price-range-display" class="text-sm text-center text-on-surface-variant opacity-0 transition-opacity duration-200 py-2 px-4 bg-surface-container rounded-lg" data-astro-cid-t5fw7d4k>
Filtrando: <span class="font-semibold text-primary" id="price-range-text" data-astro-cid-t5fw7d4k></span> </div> </div> <div id="search-results-info" class="mt-3 text-center text-sm text-on-surface-variant opacity-0 transition-opacity duration-200" data-astro-cid-t5fw7d4k></div> </div> <!-- Products by Category --> ${categories.map((category, index) => {
    const categoryProducts = products.filter((p) => p.categoryId === category.id);
    const bgColor = categoryColors[category.id] || "from-gray-50 via-gray-100 to-gray-50";
    return renderTemplate`<div class="category-section mb-20 transition-all duration-500"${addAttribute(`category-${category.id}`, "id")}${addAttribute(category.id, "data-category")} style="display: none;" data-astro-cid-t5fw7d4k> <!-- Category Header with animated background --> <div${addAttribute(`relative rounded-3xl p-8 md:p-12 mb-10 overflow-hidden bg-gradient-to-br ${bgColor}`, "class")} data-astro-cid-t5fw7d4k> <div class="absolute inset-0 opacity-10" data-astro-cid-t5fw7d4k> <div class="absolute top-0 right-0 w-64 h-64 bg-primary rounded-full blur-3xl" data-astro-cid-t5fw7d4k></div> <div class="absolute bottom-0 left-0 w-96 h-96 bg-secondary rounded-full blur-3xl" data-astro-cid-t5fw7d4k></div> </div> <div class="relative z-10 flex items-center gap-6" data-astro-cid-t5fw7d4k> <div class="w-20 h-20 md:w-24 md:h-24 bg-white rounded-2xl shadow-lg flex items-center justify-center" data-astro-cid-t5fw7d4k> <span class="material-symbols-outlined text-5xl md:text-6xl text-primary" data-astro-cid-t5fw7d4k>${category.icon}</span> </div> <div data-astro-cid-t5fw7d4k> <h2 class="font-headline text-3xl md:text-5xl font-bold text-primary tracking-tight mb-2" data-astro-cid-t5fw7d4k> ${category.name} </h2> <p class="text-on-surface-variant text-lg" data-astro-cid-t5fw7d4k>${category.description}</p> </div> </div> </div> <!-- Products Grid --> <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" data-astro-cid-t5fw7d4k> ${categoryProducts.map((product, prodIndex) => renderTemplate`<div class="product-card bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-300 group"${addAttribute(`animation-delay: ${prodIndex * 50}ms;`, "style")}${addAttribute(product.name.toLowerCase(), "data-product-name")}${addAttribute(product.description.toLowerCase(), "data-product-description")}${addAttribute(product.price, "data-product-price")} data-astro-cid-t5fw7d4k> <div class="aspect-square overflow-hidden bg-surface-container-highest relative" data-astro-cid-t5fw7d4k> <img${addAttribute(product.image, "src")}${addAttribute(product.name, "alt")} class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" loading="lazy" data-astro-cid-t5fw7d4k> <div class="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" data-astro-cid-t5fw7d4k></div> </div> <div class="p-6" data-astro-cid-t5fw7d4k> <h4 class="font-headline font-bold text-lg text-primary mb-2 line-clamp-2 group-hover:text-secondary transition-colors" data-astro-cid-t5fw7d4k> ${product.name} </h4> <p class="text-sm text-on-surface-variant mb-4 line-clamp-3" data-astro-cid-t5fw7d4k> ${product.description} </p> ${product.variants && product.variants.length > 0 && renderTemplate`<div class="mb-4" data-astro-cid-t5fw7d4k> <p class="text-xs font-semibold text-secondary mb-2" data-astro-cid-t5fw7d4k>Variantes disponibles:</p> <div class="flex flex-wrap gap-2" data-astro-cid-t5fw7d4k> ${product.variants.map((variant) => renderTemplate`<span class="text-xs px-3 py-1 bg-surface-container rounded-full text-on-surface-variant" data-astro-cid-t5fw7d4k> ${variant} </span>`)} </div> </div>`} ${product.price && renderTemplate`<div class="mb-3" data-astro-cid-t5fw7d4k> <p class="text-lg font-bold text-primary" data-astro-cid-t5fw7d4k>
