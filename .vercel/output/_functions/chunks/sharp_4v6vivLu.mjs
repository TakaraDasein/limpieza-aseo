import { A as AstroError, bd as MissingSharp } from './sequence_Cz06ISpH.mjs';
import { b as baseService, p as parseQuality } from './generic_Dp3S12yd.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_BR2BXnb0.mjs').then(n => n.i)).default;
  } catch {
